...
export default (props) => {
    return <View style={{backgroundColor:"white"}}>
        {/* 1.0 头部 */}
        <TouchableOpacity activeOpacity={0.8} style={{display:'flex',flexDirection:'row',height:35,alignItems:'center',paddingLeft:5,paddingRight:5,justifyContent:'space-between'}} onPress={()=>{
